...
///
/// All three show distance to the closest dog plus its fix-age color
/// tier. Direction indicators were tried and pulled — a complication
/// can't show live heading data so any arrow would be misleading as
/// the user rotates. Tap any family to open the in-app compass page
/// for that dog via `pawmesh://dog/<nodeNum>`, where the live arrow
/// IS available.
